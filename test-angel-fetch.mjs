...
async function testAngelLive() {
  ...
  // Test Muthoot Finance LTP (token: 23650)
  const ltpMuthoot = await fetch('https://apiconnect.angelbroking.com/rest/secure/angelbroking/order/v1/getLtpData', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
  ...
  console.log('MUTHOOTFIN AngelOne LTP:', await ltpMuthoot.json());

  // Test ICICI Bank LTP (token: 4963)
  const ltpIcici = await fetch('https://apiconnect.angelbroking.com/rest/secure/angelbroking/order/v1/getLtpData', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
  ...
  console.log('ICICIBANK AngelOne LTP:', await ltpIcici.json());
}
